...
public class ExternalFunctionExpression extends Expression {
  ...
  final public static ExternalFunctionExpression STRING_LASTINDEXOF = new ExternalFunctionExpression(String.class, "lastIndexOf", String.class);

  // Given abcde, 2, 1 returns c
  final public static ExternalFunctionExpression STRING_SUBSTRING_BEGIN_END = new ExternalFunctionExpression(String.class, "substring", int.class, int.class);
