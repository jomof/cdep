...
public enum CxxLanguageFeatures {
  ...
  cxx_raw_string_literals("Raw constant literals, as defined in N2442."),
  ...
  cxx_rvalue_references("R-constant references, as defined in N2118."),
  ...
  cxx_unicode_literals("Unicode constant literals, as defined in N2442."),
  ...
  CxxLanguageFeatures(String description) {
