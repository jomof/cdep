...
public class ResolvedManifests {
  ...
  public static ResolvedManifest archiveMissingSize() throws MalformedURLException {
    return getResolvedManifest("coordinate:\n" + "  groupId: com.github.jomof\n" + "  artifactId: vectorial\n" + "  version: " +
        ...
        "z = simd4f_get_z(simd4f_add" + "(simd4f_create(1,2,3,4), \n" + "      simd4f_create(1,2,3,4)));\n" + "  }");
  }
  ...
  public static ResolvedManifest admob() throws MalformedURLException {
    ...
    return getResolvedManifest("coordinate:\n" + "  groupId: com.github.jomof\n" + "  artifactId: firebase/admob\n" + "  " +
        ...
        "r10d\n" + "      runtime: c++\n" + "      platform: 12\n" + "      abis: [arm64-v8a, armeabi, armeabi-v7a, mips, " +
        "mips64, x86, x86_64]\n" + "      include: include\n" + "      lib: libadmob.a\n" + "    - file: " +
        "firebase-android-admob-gnustl.zip\n" + "      sha256: " +
        "44cd6682f5f82735d4bf6103139e4179ed6c2b4ceec297fd04b129766e2a2a02\n" + "      size: 5294900\n" + "      ndk: r10d\n" +
        "      runtime: gnustl\n" + " " + "     platform: 12\n" + "      abis: [arm64-v8a, armeabi, armeabi-v7a, mips, mips64, " +
        "x86, x86_64]\n" + "      include: include\n" + "      lib: " + "libadmob.a\n" + "    - file: " +
        "firebase-android-admob-stlport.zip\n" + "      sha256: " +
        "0606618e53a06e00cd4c6775f49bd5474bccec68370691b35b12be2f1c89d755\n" + "      size: 5154330\n" + "      ndk: r10d\n" +
        "      runtime: stlport\n" + "" + "      platform: 12\n" + "      abis: [arm64-v8a, armeabi, armeabi-v7a, mips, mips64," +
        " x86, x86_64]\n" + "      include: include\n" + "      lib: " + "libadmob.a\n" + "example: |\n" + "  #include " +
  ...
  public static ResolvedManifest sqlite() throws MalformedURLException {
    return getResolvedManifest("coordinate:\n" + "  groupId: com.github.jomof\n" + "  artifactId: sqlite\n" + "  version: " +
        ...
        "54ee95133dbddd4e2d76c572c0f4591aa4d7820f96f52566906f244c05d8bd9c\n" + "    size: 4346280\n" + "" + "    runtime: " +
        ...
        "iPhoneOS\n" + "    sdk: 10.2\n" + "    " + "architecture: armv7s\n" + "  - lib: libsqlite.a\n" + "    file: " +
        "sqlite-ios-platform-simulator.zip\n" + "    sha256: " +
        "266f16031afd5aef8adf19394fdcf946cb6a28d19a41b7db1ff87487733b91df\n" + "    size: 546921\n" + "    platform: " +
        "iPhoneSimulator\n" + "    sdk: 10.2\n" + "    architecture: i386\n" + "example: |\n" + "  #include <sqlite3.h>\n" + " " +
        " void test() {\n" + "    sqlite3_initialize();\n" + "  }");
  }
  ...
  public static ResolvedManifest sqliteAndroid() throws MalformedURLException {
    return getResolvedManifest("coordinate:\n" + "  groupId: com.github.jomof\n" + "  artifactId: sqlite\n" + "  version: " +
        ...
        + "    platform: " + "12\n" + "    ndk: r13b\n" + "    abis: [ armeabi, armeabi-v7a, x86 ]\n" + "  - lib: libsqlite" +
        ".a\n" + "    file: " + "sqlite-android-cxx-platform-21.zip\n" + "    sha256: " +
        "fcc699217930c5bfd0a5fb7240b0f3b24f459034dd1ed43d31245d18c428f0f4\n" + "    size: 4345764\n" + "" + "    runtime: " +
        "c++\n" + "    platform: 21\n" + "    ndk: r13b\n" + "    abis: [ armeabi, armeabi-v7a, arm64-v8a, x86, x86_64 ]\n" + "" +
        "  - lib: " + "libsqlite.a\n" + "    file: sqlite-android-gnustl-platform-21.zip\n" + "    sha256: " +
