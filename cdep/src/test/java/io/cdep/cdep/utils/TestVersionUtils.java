...
public class TestVersionUtils {
  ...
  public void majorNotNumber() {
    assertThat(VersionUtils.checkVersion("x.2.3")).isEqualTo("expected major.minor.point[-tweak] but major version 'x' wasn't a" +
        " number");
  }

  @Test
  public void minorNotNumber() {
    assertThat(VersionUtils.checkVersion("1.y.3")).isEqualTo("expected major.minor.point[-tweak] but minor version 'y' wasn't a number");
  }

  @Test
  public void pointNotNumber() {
    assertThat(VersionUtils.checkVersion("1.2.z")).isEqualTo("expected major.minor.point[-tweak] but point version 'z' wasn't a number");
  }
